...
public class AccessGlobalStatsQueryParam extends PageQueryParam{
    ...
    * 系统数。
    */
    @QueryMeta(expr = "saas_num=?")
    @Schema(title="系统数", description = "系统数")
    private Long saasNum;

    /**
    * 系统数范围。
    */
    @QueryMeta(expr = "saas_num between ? and ?")
    @Schema(title="系统数范围", description = "系统数范围")
    private Long[] saasNumRange;
    ...
    * 设置主键链式调用。
    */
    public AccessGlobalStatsQueryParam id(Long id) {
        setId(id);
        return this;
    }
    ...
    * 设置ID数组链式调用。
    */
    public AccessGlobalStatsQueryParam ids(Long[] ids) {
        setIds(ids);
        return this;
    }
    ...
    * 设置统计时间范围链式调用。
    */
    public AccessGlobalStatsQueryParam statsDateRange(Date[] statsDateRange) {
    ...
    * 设置建立时间范围链式调用。
    */
    public AccessGlobalStatsQueryParam createDateRange(Date[] createDateRange) {
    ...
    * 设置系统数链式调用。
    */
    public AccessGlobalStatsQueryParam saasNum(Long saasNum){
        setSaasNum(saasNum);
        return this;
    }
    ...
    * 获取系统数范围。
    */
    public Long[] getSaasNumRange(){
        return this.saasNumRange;
    }

    /**
    * 设置系统数范围。
    */
    public void setSaasNumRange(Long[] saasNumRange){
        this.saasNumRange = saasNumRange;
    }
	
    /**
    * 设置系统数范围链式调用。
    */
    public AccessGlobalStatsQueryParam saasNumRange(Long[] saasNumRange){
        setSaasNumRange(saasNumRange);
        return this;
    }
    ...
    * 设置用户数链式调用。
    */
    public AccessGlobalStatsQueryParam userNum(Long userNum){
        setUserNum(userNum);
        return this;
    }
    ...
    * 设置用户数范围链式调用。
    */
    public AccessGlobalStatsQueryParam userNumRange(Long[] userNumRange){
    ...
    * 设置ip数链式调用。
    */
    public AccessGlobalStatsQueryParam ipNum(Long ipNum){
        setIpNum(ipNum);
        return this;
    }
    ...
    * 设置ip数范围链式调用。
    */
    public AccessGlobalStatsQueryParam ipNumRange(Long[] ipNumRange){
    ...
    * 设置会话数链式调用。
    */
    public AccessGlobalStatsQueryParam sessionNum(Long sessionNum){
    ...
    * 设置会话数范围链式调用。
    */
    public AccessGlobalStatsQueryParam sessionNumRange(Long[] sessionNumRange){
    ...
    * 设置服务数链式调用。
    */
    public AccessGlobalStatsQueryParam serviceNum(Long serviceNum){
    ...
    * 设置服务数范围链式调用。
    */
    public AccessGlobalStatsQueryParam serviceNumRange(Long[] serviceNumRange){
    ...
    * 设置api数链式调用。
    */
    public AccessGlobalStatsQueryParam apiNum(Long apiNum){
        setApiNum(apiNum);
        return this;
    }
    ...
    * 设置api数范围链式调用。
    */
    public AccessGlobalStatsQueryParam apiNumRange(Long[] apiNumRange){
    ...
    * 设置访问量链式调用。
    */
    public AccessGlobalStatsQueryParam requestNum(Long requestNum){
    ...
    * 设置访问量范围链式调用。
    */
    public AccessGlobalStatsQueryParam requestNumRange(Long[] requestNumRange){
    ...
    * 设置请求数据量链式调用。
    */
    public AccessGlobalStatsQueryParam requestSize(Long requestSize){
    ...
    * 设置请求数据量范围链式调用。
    */
    public AccessGlobalStatsQueryParam requestSizeRange(Long[] requestSizeRange){
    ...
    * 设置响应数据量链式调用。
    */
    public AccessGlobalStatsQueryParam responseSize(Long responseSize){
    ...
    * 设置响应数据量范围链式调用。
    */
    public AccessGlobalStatsQueryParam responseSizeRange(Long[] responseSizeRange){
    ...
    * 设置响应总时间链式调用。
    */
    public AccessGlobalStatsQueryParam responseMillis(Long responseMillis){
    ...
    * 设置响应总时间范围链式调用。
    */
    public AccessGlobalStatsQueryParam responseMillisRange(Long[] responseMillisRange){
    ...
    * 设置500代码数链式调用。
    */
    public AccessGlobalStatsQueryParam response500(Long response500){
    ...
    * 设置500代码数范围链式调用。
    */
    public AccessGlobalStatsQueryParam response500Range(Long[] response500Range){
    ...
    * 设置404代码数链式调用。
    */
    public AccessGlobalStatsQueryParam response404(Long response404){
    ...
    * 设置404代码数范围链式调用。
    */
    public AccessGlobalStatsQueryParam response404Range(Long[] response404Range){
    ...
    * 设置401代码数链式调用。
    */
    public AccessGlobalStatsQueryParam response401(Long response401){
    ...
    * 设置401代码数范围链式调用。
    */
    public AccessGlobalStatsQueryParam response401Range(Long[] response401Range){
    ...
    * 设置403代码数链式调用。
    */
    public AccessGlobalStatsQueryParam response403(Long response403){
    ...
    * 设置403代码数范围链式调用。
    */
    public AccessGlobalStatsQueryParam response403Range(Long[] response403Range){
