 ...
 * @author axeon
 */
@TableMeta(tableName="access_saas_stats",tableType="table")
@Schema(title = "saas访问统计", description = "saas访问统计")
public class AccessSaasStats implements DataEntity,Serializable{
     ...
     *  设置主键链式调用。
     */
    public AccessSaasStats id(long id){
        setId(id);
        return this;
    }
     ...
     *  设置saasId链式调用。
     */
    public AccessSaasStats saasId(long saasId){
        setSaasId(saasId);
        return this;
    }
     ...
     *  设置统计时间链式调用。
     */
    public AccessSaasStats statsDate(java.util.Date statsDate){
     ...
     *  设置建立时间链式调用。
     */
    public AccessSaasStats createDate(java.util.Date createDate){
     ...
     *  设置用户数链式调用。
     */
    public AccessSaasStats userNum(long userNum){
        setUserNum(userNum);
        return this;
    }
     ...
     *  设置ip数链式调用。
     */
    public AccessSaasStats ipNum(long ipNum){
        setIpNum(ipNum);
        return this;
    }
     ...
     *  设置会话数链式调用。
     */
    public AccessSaasStats sessionNum(long sessionNum){
     ...
     *  设置服务数链式调用。
     */
    public AccessSaasStats serviceNum(long serviceNum){
     ...
     *  设置api数链式调用。
     */
    public AccessSaasStats apiNum(long apiNum){
        setApiNum(apiNum);
        return this;
    }
     ...
     *  设置访问量链式调用。
     */
    public AccessSaasStats requestNum(long requestNum){
     ...
     *  设置请求数据量链式调用。
     */
    public AccessSaasStats requestSize(long requestSize){
     ...
     *  设置响应数据量链式调用。
     */
    public AccessSaasStats responseSize(long responseSize){
     ...
     *  设置响应总时间链式调用。
     */
    public AccessSaasStats responseMillis(long responseMillis){
     ...
     *  设置500代码数链式调用。
     */
    public AccessSaasStats response500(long response500){
     ...
     *  设置404代码数链式调用。
     */
    public AccessSaasStats response404(long response404){
     ...
     *  设置401代码数链式调用。
     */
    public AccessSaasStats response401(long response401){
     ...
     *  设置403代码数链式调用。
     */
    public AccessSaasStats response403(long response403){
