 ...
 */
@RestController
@RequestMapping("/root/acl/filter")
...
public class MscAclFilterController {
    ...
    @MscPermDeclare(user = UserType.ROOT, auth = AuthType.USER, log = ActionLog.NONE)
    public ResponseData<MscAclFilterResult> testFilterIp(@Parameter(description = "saasId") @RequestParam long saasId, @Parameter(description = "用户类型") @RequestParam int userType,
                                                         @Parameter(description = "用户Id") @RequestParam long userId, @Parameter(description = "访问IP") @RequestParam String ipPermit) {
